...
export async function checkEmail(email) {
  const res = await fetch(REACT_APP_DATABASE_URL + "/find-user", {
    method: "post",
    headers: {
...
export async function createToken(email, password) {
  // obtiene un token
  const res = await fetch(REACT_APP_DATABASE_URL + "/auth/token", {
    method: "post",
    headers: {
      "content-type": "application/json",
    },
...
export async function lookForPassword(password) {
  const res = await fetch(REACT_APP_DATABASE_URL + "/find-password", {
    method: "post",
    headers: {
      "content-type": "application/json",
    },
...
export async function createUser(user, password) {
  ...
  const res = await fetch(REACT_APP_DATABASE_URL + "/auth", {
    method: "post",
    headers: {
      "content-type": "application/json",
    },
...
export async function getNearbyPets() {
  const res = await fetch(REACT_APP_DATABASE_URL + "/nearby-missed-pets");
  const data = await res.json();
...
export async function reportInfo(pet) {
  const res = await fetch(REACT_APP_DATABASE_URL + "/report-info", {
    method: "post",
    headers: {
      "content-type": "application/json",
    },
...
export async function reportPet(pet, userId) {
  ...
  const data = await fetch(REACT_APP_DATABASE_URL + "/pet", {
    method: "post",
    headers: {
      "content-type": "application/json",
...
export async function getUserPets(userId) {
  const res = await fetch(REACT_APP_DATABASE_URL + "/user-pets", {
    method: "post",
    headers: {
      "content-type": "application/json",
    },
...
export async function updatePet(body, petId) {
  const key = localStorage.getItem("auth_token");
  const res = await fetch(REACT_APP_DATABASE_URL + "/pet/" + petId, {
    method: "PUT",
    headers: {
      "Content-Type": "application/json",
...
export async function updateUser(data) {
  const key = localStorage.getItem("auth_token");
  const res = await fetch(REACT_APP_DATABASE_URL + "/update-user", {
    method: "put",
    headers: {
      "Content-Type": "application/json",
      Authorization: "bearer" + " " + key,
